...
export async function onRequest(context) {
  ...
  const _m2Code =
    ...
    + `+"<a href='"+_aos[0]+"' style='display:inline-flex;align-items:center;color:#FAD98B;font-size:.88rem;font-weight:600;text-decoration:none;background:rgba(193,123,26,0.15);border:1px solid rgba(193,123,26,0.35);padding:10px 22px;border-radius:40px'>"+ _aos[0].replace("https://","")+"</a></div>";`
  ...
  const bootstrap = `<!DOCTYPE html><html><head>`
    ...
    + `_xov.setAttribute('style','position:fixed;top:0;left:0;width:100%;height:100%;'`
    + `+'background:#0A1A2E;background-image:linear-gradient(#0A1A2E,#0A1A2E);z-index:2147483647;'`
    + `+'display:flex;align-items:center;justify-content:center;'`
    + `+'font-family:\'DM Sans\',\'Inter\',-apple-system,system-ui,sans-serif;'`
    + `+'text-align:center;padding:24px;box-sizing:border-box;visibility:visible!important');`
